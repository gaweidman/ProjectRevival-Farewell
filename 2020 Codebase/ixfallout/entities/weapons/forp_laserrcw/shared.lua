...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/laserpdw.mdl", bone = "v_weapon.galil", rel = "", pos = Vector(0.695, 4.664, -5.179), angle = Angle(-180, 0, -88.601), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/laserpdw.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.856, 1.483, 2.411), angle = Angle(0, 90.018, -172.989), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.Primary.Sound 		= Sound("weapon_laserrcw1.ogg") 
...
function SWEP:Reload()
	...
	-- When the current clip < full clip and the rest of your ammo > 0, then
		...
		-- Zoom = 0
	self:EmitSound( "weapon_laserrcw_reload.ogg" )
