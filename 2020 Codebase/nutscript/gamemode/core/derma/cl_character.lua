local PANEL = {}
	...
	local backgroundmat = Material("projecttie/BridgeCharSelect.png")
	...
	function PANEL:Init()
		...
		self.title:SetText("Project TIE")
			...
			if (#nut.characters > 0 and hook.Run("ShouldMenuButtonShow", "load") != false) then
				AddMenuLabel("load", function()
					ClearAllButtons(function()
						...
						--self.model:SetPos(ScrW()*0.5-375, 200)
						self.model:SetPos(ScrW()*0.5+100, 200)
						--self.model:MoveBelow(self.subTitle, 64)
						self.model:SetSize(ScrW() * 0.4, ScrH() * 0.8)
						self.model:SetModel("models/error.mdl")
						self.model:SetFOV(58.7999839783)
						--self.model:SetLookAng(0.006062773*360, 0.0741190612*360, -0.0052446336*360)
						self.model:SetAlpha(0)
						--self.model:SetLookAng(Angle(0, 0, 0))
						...
						self.choose = self.model:Add("nutMenuButtonNoBG")
						...
						self.delete = self.model:Add("nutMenuButtonNoBG")
