...
nut.anim.setModelClass("models/epangelmatikes/royalguard/shawod_guard.mdl", "player")
nut.anim.setModelClass("models/epangelmatikes/royalguard/royal_guard.mdl", "player")
nut.anim.setModelClass("models/epangelmatikes/royalguard/sovereign_protector.mdl", "player")
nut.anim.setModelClass("models/epangelmatikes/nc/neo_crusader_g.mdl", "player")
nut.anim.setModelClass("models/range_trooper/range_trooper.mdl", "player")
nut.anim.setModelClass("models/bananakin/thrawn/imperial_thrawn_player.mdl", "player")
nut.anim.setModelClass("models/arachnit/doom_eternal/characters/doom_slayer_marine_guy/doom_slayer_marine_guy_pm.mdl", "player")
nut.anim.setModelClass("models/fisher/501st/rex/rex.mdl", "player")
nut.anim.setModelClass("models/fisher/501st/dogma/dogma.mdl", "player")
nut.anim.setModelClass("models/fisher/501st/kix/kix.mdl", "player")
nut.anim.setModelClass("models/fisher/501st/hardcase/hardcase.mdl", "player")
nut.anim.setModelClass("models/fisher/501st/jesse/jesse.mdl", "player")
nut.anim.setModelClass("models/sally/tkaro/bx_commando_droid.mdl", "player")
nut.anim.setModelClass("models/fisher/501st/legion/legion.mdl", "player")
nut.anim.setModelClass("models/kaiido/anakin/anakin.mdl", "player")
nut.anim.setModelClass("models/fisher/501st/appo/appo.mdl", "player")
nut.anim.setModelClass("models/kryptonite/luke/bf_luke.mdl", "player")
nut.anim.setModelClass("models/kryptonite/sbfii_kylo_ren/sbfii_kylo_ren2.mdl", "player")
nut.anim.setModelClass("models/grady/fo_executioner_stormtrooper/fo_executioner_stormtrooper.mdl", "player")
nut.anim.setModelClass("models/grady/fo_heavy_stormtrooper/fo_heavy_stormtrooper.mdl", "player")
nut.anim.setModelClass("models/grady/fo_jet_stormtrooper/fo_jet_stormtrooper.mdl", "player")
nut.anim.setModelClass("models/grady/fo_stormtrooper/fo_stormtrooper.mdl", "player")
nut.anim.setModelClass("models/kryptonite/rey/bf2_rey.mdl", "player")
nut.anim.setModelClass("models/bunny/2-1bmedical/2-1bmedicaldroid.mdl", "player")
