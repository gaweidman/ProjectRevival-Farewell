		...
		nut.chat.register("ooc", {
			...
			onChatAdd = function(speaker, text)
				...
				elseif (speaker:SteamID() == "STEAM_0:0:19814083") then -- Black Tea the edgiest man
					icon = "icon16/gun.png"
				elseif (speaker:SteamID() == "STEAM_0:1:53097688") then -- Gabe
					icon = "icon16/monkey.png"
				elseif (speaker:IsUserGroup("mod")) then
					icon = "icon16/wrench.png"
				elseif (speaker:IsUserGroup("trialmod")) then
					icon = "icon16/wrench.png"
				elseif (speaker:IsUserGroup("deputy")) then
					icon = "icon16/eye.png"
				elseif (speaker:IsSuperAdmin()) then
					icon = "icon16/shield.png"
				elseif (speaker:IsUserGroup("vip")) then
					icon = "icon16/star.png"
				elseif (speaker:IsUserGroup("supporter")) then
					icon = "icon16/tick.png"
				elseif (speaker:IsUserGroup("gamer")) then
					icon = "icon16/heart.png"
				elseif (speaker:IsUserGroup("truegamer")) then
					icon = "icon16/controller.png"
				elseif (speaker:IsUserGroup("donator")) then
					icon = "icon16/rainbow.png"
				elseif (speaker:IsUserGroup("og")) then
