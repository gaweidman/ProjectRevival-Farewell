...
function PANEL:Init()
	...
	if (logo and !logo:IsError()) then
		...
		titleLabel:SetText("Project Revival DEV SERVER")
		...
		if (subtitle) then
			...
			subtitleLabel:SetText("A serious roleplay server based off of the Half-Life 2 Beta.")
	...
	local prlogo = self:Add("DImage")
	prlogo:SetImage("vgui/prlogo-400px.png")
	prlogo:SetPos(ScrW()/2 - 25, ScrH()/2 - 25 - ScrH()/4.6)
	prlogo:SetSize(50, 50)
