...
if (SERVER) then
	...
	-- @see LeaveSequence
	function playerMeta:ForceSequence(sequence, callback, time, bNoFreeze, bNoRestrictWeapons)
		...
		if (sequence and sequence > 0) then
			...
			if bNoRestrictWeapons == nil then
				bNoRestrictWeapons = false
			end
			...
			print(self:GetNetVar("canShoot", false))
