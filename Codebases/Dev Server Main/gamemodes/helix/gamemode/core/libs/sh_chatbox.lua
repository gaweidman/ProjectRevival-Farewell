	...
	hook.Add("InitializedConfig", "ixChatTypes", function()
		...
		ix.chat.Register("ic", {
			...
			OnChatAdd = function(self, speaker, text)
				...
				if speaker:IsVocoded() then
					chat.AddText(chatColor, speaker:GetCharacter():GetName().." says \"", Color(214, 214, 214), text, chatColor, "\"")
				else
		...
		ix.chat.Register("y", {
			...
			OnChatAdd = function(self, speaker, text)
				...
				chat.AddText(chatColor, speaker:GetCharacter():GetName().." yells \"", color_white, text, chatColor, "\"")
			end,
		})
