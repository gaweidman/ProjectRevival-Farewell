...
function PANEL:Init()
	...
	if (logo and !logo:IsError()) then
		...
		titleLabel:SetFont("ixFalloutTitle")
		titleLabel:SetText(L2("schemaName") or Schema.name or L"unknown")
		titleLabel:SizeToContents()
		titleLabel:SetWide(titleLabel:GetWide() * 1.06)
...
function PANEL:Init()
	...
	self.bg = vgui.Create("DImage", self)
	self.bg:SetImage("materials/vgui/FalloutBackground.png")
	self.bg:SetImageColor(Color(100, 100, 100))
	self.bg:SetPos(0, 0)
