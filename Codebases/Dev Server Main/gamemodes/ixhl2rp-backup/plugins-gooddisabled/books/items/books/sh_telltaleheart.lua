ITEM.name = "The Telltale Heart"
ITEM.description = "A book featuring a realistic drawing of a human heart on the cover."
ITEM.price = 0
...
function ITEM:PopulateTooltip(tooltip)
    ...
    tip:SetText("Written by Nathaniel Hawthorne.")
    tip:SetFont("DermaDefault")
    tip:SizeToContents()
end

ITEM.contents = [[ 
    <!-- saved from url=(0051)http://xroads.virginia.edu/~Hyper/POE/telltale.html -->
    <html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252"><title>The Tell-Tale Heart by Edgar Allan Poe
    </title>
    ...
    <p>
      <font size="+3">T</font>RUE! --nervous --very, very dreadfully nervous 
    I had been and am;
    ...
    </p><p> It is impossible to say how first the idea entered my brain; but
    ...
    forever.
    </p><p> Now this is the point. You fancy me mad. Madmen know nothing.
    ...
    </p><p> Upon the eighth night I was more than usually cautious in
    ...
    </p><p> I had my head in, and was about to open the lantern, when my thumb
    slipped upon the tin fastening, and the old man sprang up in bed,
    crying out --"Who's there?"
    </p><p> I kept quite still and said nothing. For a whole hour I did not
    ...
    </p><p> Presently I heard a slight groan, and I knew it was the groan of
    ...
    </p><p> When I had waited a long time, very patiently, without hearing him
    ...
    </p><p> It was open --wide, wide open --and I grew furious as I gazed upon
    ...
    </p><p> And have I not told you that what you mistake for madness is but
    ...
    </p><p> But even yet I refrained and kept still. I scarcely breathed. I
    ...
    trouble me no more.
    </p><p> If still you think me mad, you will think so no longer when I
    ...
    the legs.
    </p><p> I then took up three planks from the flooring of the chamber,
    ...
    </p><p> When I had made an end of these labors, it was four o'clock
    ...
    search the premises.
    </p><p> I smiled, --for what had I to fear? I bade the gentlemen
    ...
    </p><p> The officers were satisfied. My manner had convinced them. I was
    ...
    my ears.
    </p><p> No doubt I now grew very pale; --but I talked more fluently, and
    ...
    </p><p> "Villains!" I shrieked, "dissemble no more! I admit the deed!
    --tear up the planks! here, here! --It is the beating of his hideous
    heart!"
    </p><p>
    </p><p></p><center> -THE END- </center>
    <p>
    </p><p>
    </p><p>
    <p></p>
