...
hook.Add("LoadFonts", "ixFontOverrides", function(font, genericFont)
	...
	surface.CreateFont("prMediumMenuFontThin", {
		font = "Khand Light",
		size = 45,
		extended = true,
		weight = 100
	...
	surface.CreateFont("prLargeMenuFont", {
		font = "Khand Regular",
		size = 55,
		extended = true,
		weight = 100
...
local vortessenceBarColor = Color(41, 184, 0)
local drainedBarColor = Color(4, 18, 0)
local transcendantBarColor = Color(132, 0, 255)
local drainedBarColorTranscendant = Color(68, 0, 68)
...
hook.Add("HUDPaint", "CombineHUD", function()
	...
	for k, v in ipairs(ents.FindByClass("ix_testent10")) do
		local pos = v:GetPos()
