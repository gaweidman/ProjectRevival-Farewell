ITEM.name = "CWU Leadership Suit"
ITEM.description = "A baggy orange suit made to protect citizens from the elements while working."
...
ITEM.replacements = "models/hlvr/characters/worker/worker_player.mdl"
ITEM.newSkin = 1
ITEM.bodyGroups = {
	["Uniform Variant"] = 1,
}
