...
function PLUGIN:PlayerDeath(client, inflictor, attacker)
		if attacker:IsPlayer() then
			//ix.log.AddRaw(client:Name() .. " was killed by " .. attacker:Name() .. " using " .. (attacker:GetActiveWeapon():GetClass() or "UNKNOWN"), nil, Color(255,50,50))
		else
...
ix.option.Add("itemESP", ix.type.bool, true)
	...
	function PLUGIN:HUDPaint()
		...
		if ((client:IsAdmin() or client:GetUserGroup() == "moderator" or client:GetUserGroup() == "trialmod") and client:GetMoveType() == MOVETYPE_NOCLIP and not client:InVehicle() and ix.option.Get("observerESP", true)) then
...
/*
function playerMeta:HasBiosignalCommand()
	return Schema:HasBiosignalRank(self:Name(), "CL") or Schema:HasBiosignalRank(self:Name(), "RL")
end
