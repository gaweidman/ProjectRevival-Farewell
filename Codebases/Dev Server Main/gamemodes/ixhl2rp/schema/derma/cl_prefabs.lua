...
function PANEL:Init()
    ...
    local fontHeight = draw.GetFontHeight("DermaLarge")
    self.image = vgui.Create("DImage", self)
    self.image:SetImage("icon16/add.png")
    self.image:SetSize(16+8, 16 + 8)
    self.image:SetPos(5, 5 + (18))
    self.image:DockMargin(4, SizeY/2 - self.image:GetTall() + 2, 5, SizeY/2 - self.image:GetTall() + 2)
    self.image:Dock(LEFT)
    --self.image:SetSize(16, 16)
    self:DockPadding(0,  1 + (18), 0, 0)
    ...
    self.label:SetY(SizeY/2 - self.label:GetTall()/2)
...
function PANEL:PopulateText()
    if (self.logType == "AddAct") then
        self:SetText(self.data.editor.." added a loyal act.")
    elseif (self.logType == "AddVio") then
        self:SetText(self.data.editor.." added a violation.")
    elseif (self.logType == "EditAct") then
        self:SetText(self.data.editor.." edited a loyal act.")
    elseif (self.logType == "EditVio") then
        self:SetText(self.data.editor.." edited a violation.")
    elseif (self.logType == "DelAct") then
        self:SetText(self.data.editor.." deleted a loyal act.")
    elseif (self.logType == "DelVio") then
        self:SetText(self.data.editor.." deleted a violation.")
    elseif (self.logType == "EditInfo") then
        self:SetText(self.data.editor.." edited the individual's information.")
    elseif (self.logType == "MakeBOL") then
        self:SetText(self.data.editor.." marked the individual as BOL.")
    elseif (self.logType == "RemBOL") then
        self:SetText(self.data.editor.." removed the individual's BOL status.")
    elseif (self.logType == "MakeWant") then
        self:SetText(self.data.editor.." marked the individual as wanted.")
    elseif (self.logType == "RemWant") then
        self:SetText(self.data.editor.." removed the individual's wanted status.")
    elseif (self.logType == "MakeSus") then
        self:SetText(self.data.editor.." marked the individual as suspicious.")
    elseif (self.logType == "RemSus") then
        self:SetText(self.data.editor.." removed the individual's suspicious status.")
    elseif (self.logType == "MakeHis") then
        self:SetText(self.data.editor.." marked the individual as having a history of violence.")
    elseif (self.logType == "RemHis") then
        self:SetText(self.data.editor.." removed the individual's history of violence status.")
    elseif (self.logType == "MakeFof") then
        self:SetText(self.data.editor.." marked the individual as a frequent offender.")
    elseif (self.logType == "RemFof") then
        self:SetText(self.data.editor.." removed the individual's frequent offender status.")
    elseif (self.logType == "MakePhy") then
        self:SetText(self.data.editor.." marked the individual as a possible 10-102P.")
    elseif (self.logType == "RemPhy") then
        self:SetText(self.data.editor.." removed the individual's possible 10-102P status.")
    elseif (self.logType == "MakeMen") then
        self:SetText(self.data.editor.." marked the individual as a possible 10-102M.")
    elseif (self.logType == "RemMen") then
        self:SetText(self.data.editor.." removed the individual's possible 10-102M status.")
    else
