...
function PANEL:PaintOver(width, height)
	//draw.SimpleTextOutlined("<:: SOCIOSTATUS: "..Schema.socioWord.." ::>", "ixCMBLabelBig", ScrW() - ScrW()*0.015, 0, Schema.socioColor, TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, 3, Schema.socioOutline )
