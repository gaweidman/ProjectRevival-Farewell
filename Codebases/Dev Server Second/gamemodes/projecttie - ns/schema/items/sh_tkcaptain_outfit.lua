ITEM.name = "Stormtrooper Captain Armor"
ITEM.desc = "A suit of stormtrooper armor."
ITEM.category = "Outfit"
ITEM.model = "models/props_c17/BriefCase001a.mdl"
ITEM.width = 2
ITEM.height = 4
ITEM.outfitCategory = "model"
ITEM.replacements = "models/nate159/swbf2015/npc/stormtrooper_npc.mdl"
ITEM.bodyGroups = {
	["Shoulderpad"] = 2,
	["backpack"] = 1,
	["ShoulderPouches"] = 1
...
ITEM:hook("Equip", function(item) item.player:SetArmor(50) end)
