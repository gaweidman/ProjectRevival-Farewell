...
function THEME:Initialize()
	...
	Clockwork.option:SetColor( "background", Color(255, 255, 255, 255) );
	Clockwork.option:SetColor( "target_id", Color(255, 255, 255, 255) );
	
	Clockwork.option:SetFont("bar_text", "hl2_ThickArial");
	Clockwork.option:SetFont("main_text", "hl2_ThickArial");
	Clockwork.option:SetFont("hints_text", "hl2_ThickArial");
	Clockwork.option:SetFont("large_3d_2d", "hl2_ThickArial");
	Clockwork.option:SetFont("menu_text_big", "hl2_ThickArial");
	Clockwork.option:SetFont("menu_text_huge", "hl2_ThickArial");
	Clockwork.option:SetFont("target_id_text", "hl2_ThickArial");
	Clockwork.option:SetFont("cinematic_text", "hl2_ThickArial");
	Clockwork.option:SetFont("date_time_text", "hl2_ThickArial");
	Clockwork.option:SetFont("intro_text_big", "hl2_ThickArial");
	Clockwork.option:SetFont("menu_text_tiny", "hl2_ThickArial");
	Clockwork.option:SetFont("menu_text_small", "hl2_ThickArial");
	Clockwork.option:SetFont("intro_text_tiny", "hl2_ThickArial");
	Clockwork.option:SetFont("intro_text_small", "hl2_ThickArial");
	Clockwork.option:SetFont("player_info_text", "hl2_ThickArial");
end;
...
THEME.skin.bgColorSleep = Color(255, 255, 255, 255);
THEME.skin.bgColorDark = Color(255, 255, 255, 255);
THEME.skin.bgColor = Color(255, 255, 255, 225);

THEME.skin.controlColorHighlight = Color(255, 255, 255, 255);
THEME.skin.controlColorActive = Color(255, 255, 255, 255);
THEME.skin.controlColorBright = Color(255, 255, 255, 255);
THEME.skin.controlColorDark = Color(255, 255, 255, 255);
THEME.skin.controlColor = Color(255, 255, 255, 255);
...
THEME.skin.colTabShadow = Color(255, 255, 255, 255);
