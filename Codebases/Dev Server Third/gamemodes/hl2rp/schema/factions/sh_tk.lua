...
local FACTION = Clockwork.faction:New("Stormtrooper");
...
FACTION.models = {
	female = {"models/player/bunny/imperial_stormtrooper/stormtrooper_trooper.mdl"},
	male = {"models/player/bunny/imperial_stormtrooper/stormtrooper_trooper.mdl"}
};
FACTION.weapons = {
...
function FACTION:GetName(player, character)
	return "TK-"..Clockwork.kernel:ZeroNumberToDigits(math.random(1, 9999), 5);
end;
