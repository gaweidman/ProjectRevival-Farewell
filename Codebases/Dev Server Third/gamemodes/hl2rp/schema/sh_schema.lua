...
Clockwork.option:SetKey("intro_image", "materials/logo6white.png");
Clockwork.option:SetKey("schema_logo", "materials/logo6white.png");
Clockwork.option:SetKey("menu_music", "music/imperialmarch.mp3");
...
Clockwork.command:AddAlias("StorageGiveCash", "StorageGiveCredits");
Clockwork.command:AddAlias("StorageTakeCash", "StorageTakeCredits");
Clockwork.command:AddAlias("GiveCash", "GiveCredits");
Clockwork.command:AddAlias("DropCash", "DropCredits");
Clockwork.command:AddAlias("SetCash", "SetCredits");
