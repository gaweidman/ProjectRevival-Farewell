		...
		nut.chat.register("ooc", {
			...
			onChatAdd = function(speaker, text)
				...
				elseif (speaker:SteamID() == "STEAM_0:0:19814083") then -- Black Tea the edgiest man
					icon = "icon16/gun.png"
				elseif (speaker:SteamID() == "STEAM_0:1:53097688") then
					icon = "icon16/monkey.png"
				elseif (speaker:IsUserGroup("moderator") or speaker:IsUserGroup("operator") or speaker:IsUserGroup("trialmod")) then
