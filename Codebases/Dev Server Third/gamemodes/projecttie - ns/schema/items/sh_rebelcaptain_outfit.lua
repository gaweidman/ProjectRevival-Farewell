ITEM.name = "Rebel Captain Uniform"
ITEM.desc = "The uniform of a rebel captain."
	...
	onRun = function(item)
		...
		if (type(item.onGetReplacement) == "function") then
			...
			if (char:getModel() == "models/humans/group01/male_01.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_01.mdl")
			elseif (char:getModel() == "models/humans/group01/male_02.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_02.mdl")
			elseif (char:getModel() == "models/humans/group01/male_03.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_03.mdl")
			elseif (char:getModel() == "models/humans/group01/male_04.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_04.mdl")
			elseif (char:getModel() == "models/humans/group01/male_05.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_05.mdl")
			elseif (char:getModel() == "models/humans/group01/male_06.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_06.mdl")
			elseif (char:getModel() == "models/humans/group01/male_07.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_07.mdl")
			elseif (char:getModel() == "models/humans/group01/male_08.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_08.mdl")
			elseif (char:getModel() == "models/humans/group01/male_09.mdl") then
				char:setModel("models/sgg/starwars/rebels/r_trooper_captain/male_09.mdl")
...
ITEM:hook("Equip", function(item) item.player:SetArmor(20) end)
