PLUGIN.name = "City Ancillary Commission"
PLUGIN.author = "QIncarnate & JohnnyReaper"
...
function PLUGIN:PostPlayerLoadout(client) 
	if client:GetCharacter():GetFaction() == FACTION_CAC and client:GetCharacter():GetClass() == CLASS_CREMATOR then
