...
ITEMS["judgei5armor"] = {
    name = "CCA JUDGE i5 Armor",
    description = "A set of armor and regular clothes with a plastic mask.",
    model = "models/props_c17/BriefCase001a.mdl",
    width = 1,
    height = 1,
    skin = 0,
    dt = DTTable(5, 4, 8, 3, 2, 5),
    outfitCategory = "model",
    replacements = "models/police_nemez.mdl",
    newSkin = 5
}

ITEMS["unioni1armor"] = {
    name = "CCA UNION i1 Armor",
    description = "A set of armor and regular clothes with a plastic mask.",
    model = "models/props_c17/BriefCase001a.mdl",
    width = 1,
    height = 1,
    skin = 0,
    dt = DTTable(6, 5, 10, 4, 3, 6),
    outfitCategory = "model",
    replacements = "models/police_nemez.mdl",
    newSkin = 4,
    bodyGroups = {
