...
function CLASS:CanSwitchTo(client)
	return Schema:HasBiosignalRank(client:Name(), "SCN") or Schema:HasBiosignalRank(client:Name(), "SHIELD")
end
...
function CLASS:OnSpawn(client)
	if (IsValid(client.ixScanner) and !client.ixScanner.bPendingRemove) then
		...
		Schema:CreateScanner(client, Schema:HasBiosignalRank(client:Name(), "SHIELD") and "npc_clawscanner" or nil)
	end
end
