ITEM.name = "Infestation Control Suit"
ITEM.description = "A black and yellow airtight suit with various Combine emblems on it."
...
ITEM.replacements = "models/hlvr/characters/hazmat_worker/hazmat_worker_player.mdl"
